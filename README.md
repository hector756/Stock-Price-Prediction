The repository contains the research paper ***Stock Market Prediction Using Machine*** Learning which explains stock market price prediction using ML techniques like ***LSTM*** and ***Linear regression***. 
